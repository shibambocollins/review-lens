// Ordered most-specific-first: the first keyword match wins. Used as the fallback when an
// exact photo of the business (Google Places) isn't available.
...
/** Best-effort category match for a business's photo when no exact photo is available. */
