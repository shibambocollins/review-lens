  ...
  return (
    <div className="max-w-7xl mx-auto pb-12 print:max-w-full print:p-0">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 print:hidden gap-4">
        <button
          onClick={onBack}
          className="flex items-center text-[#6B705C] hover:text-[#2B2B2B] transition-colors font-medium"
        >
          <ArrowLeft size={20} className="mr-2" /> Back to Search
        </button>
        <div className="flex space-x-3">
          <button
            onClick={() => onCompare(business.id)}
            className="flex items-center px-4 py-2 bg-[#FFFFFF] border border-[#6B705C]/30 rounded-lg text-[#2B2B2B]/90 hover:bg-[#FAF8F3] transition-colors shadow-sm font-medium"
          >
          ...
          <button
            ...
            className="flex items-center px-4 py-2 bg-[#2D6A4F] text-[#FFFFFF] rounded-lg hover:bg-[#1e4735] transition-colors shadow-sm font-medium disabled:opacity-50"
          >
      ...
      <div ref={reportRef}>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8 items-start">
          <img
            ...
            className="w-full md:w-48 h-48 object-cover rounded-xl shadow-md border border-[#6B705C]/10"
          />
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-2">
              <Badge variant="primary">{business.category}</Badge>
              <span className="flex items-center text-[#6B705C] font-bold">
                <Star size={18} className="fill-current text-amber-500 mr-1" />{" "}
                {business.rating}
              </span>
              <span className="text-[#6B705C]/80 text-sm">
                ({business.reviewCount?.toLocaleString()} reviews)
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl font-extrabold text-[#2B2B2B] mb-2 tracking-tight">
              {business.name}
            </h1>
        ...
        <div className="space-y-8">
          ...
          {(activeTab === "overview" ||
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="p-5">
                  ...
                  <div className="text-3xl font-extrabold text-[#2B2B2B] flex items-end space-x-2">
                    ...
                    <span
                      className={`text-sm mb-1 font-bold ${business.sentiment.score > 7 ? "text-[#2D6A4F]" : "text-[#6B705C]"}`}
                    >
                ...
                <Card className="p-5">
                  <div className="text-[#6B705C] text-sm font-semibold mb-1">
                ...
                <Card className="p-5">
                  <div className="text-[#2D6A4F] text-sm font-bold mb-1">
                    Top Rated Aspect
                  </div>
                  <div className="text-2xl font-bold text-[#2B2B2B] truncate">
                    {
                      business.aspects.reduce((prev, current) =>
                ...
                <Card className="p-5">
                  <div className="text-[#C65D3B] text-sm font-bold mb-1">
                    Top Area to Improve
                  </div>
                  <div className="text-2xl font-bold text-[#2B2B2B] truncate">
                    {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Sentiment Pie Chart */}
                <Card className="p-6">
                  <h3 className="text-lg font-bold text-[#2B2B2B] mb-4 border-b border-[#6B705C]/20 pb-2">
                      ...
                      <RechartsPieChart>
                        <Pie
                          data={[
                            {
                              name: "Positive",
                              value: business.sentiment.positive,
                            },
                            {
                              name: "Neutral",
                              value: business.sentiment.neutral,
                            },
                            {
                              name: "Negative",
                              value: business.sentiment.negative,
                            },
                          ]}
                          cx="50%"
                          cy="50%"
                  ...
                  <div className="flex justify-around text-center mt-4 border-t border-[#6B705C]/10 pt-4">
                    <div>
                      ...
                      <div className="text-xs font-semibold text-[#6B705C]">
                        Positive
                      </div>
                    </div>
                    <div>
                      <div className="text-2xl font-extrabold text-[#6B705C]">
                    ...
                    <div>
                      <div className="text-2xl font-extrabold text-[#C65D3B]">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <YAxis
                          ...
                          axisLine={false}
                          tickLine={false}
                          tick={{ fill: COLORS.secondary, fontWeight: 500 }}
                          width={90}
                        />
                        <RechartsTooltip
                          cursor={{ fill: `${COLORS.secondary}11` }}
                          contentStyle={{
                            borderRadius: "8px",
                            border: `1px solid ${COLORS.secondary}33`,
                          }}
                          ...
                          {business.emotions.map((entry, index) => (
                            <Cell
                              ...
                              fill={
                                ...
                                entry.name === "Relaxed" ||
                                entry.name === "Productive"
                                  ? COLORS.positive
                                  : entry.name === "Frustrated" ||
                                      entry.name === "Angry" ||
                                      entry.name === "Disappointed"
                                    ? COLORS.negative
                                    : COLORS.neutral
                              }
                            />
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <XAxis
                        dataKey="month"
                        tick={{ fill: COLORS.secondary, fontWeight: 500 }}
                        axisLine={{ stroke: `${COLORS.secondary}33` }}
                        tickLine={false}
                      />
                      <YAxis
                        domain={["auto", "auto"]}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 print:break-inside-avoid">
                <Card className="p-6 bg-[#FAF8F3]/50 border-[#6B705C]/10">
                  ...
                  <ul className="space-y-3">
                    {business.insights.map((insight, idx) => (
                      <li
                        key={idx}
                        className="flex items-start bg-[#FFFFFF] p-3 rounded-lg shadow-sm border border-[#6B705C]/10"
                      >
                        <div className="min-w-6 text-[#6B705C] font-bold mr-2 mt-0.5">
                          •
                        </div>
                        <span className="text-[#2B2B2B]/90 text-sm font-medium">
                          {insight}
                        </span>
                      </li>
                    ))}
                ...
                <Card className="p-6 bg-[#FAF8F3]/50 border-[#6B705C]/10">
                  <h3 className="text-lg font-bold text-[#2B2B2B] mb-4 flex items-center">
                    <TrendingUp className="mr-2 text-[#2D6A4F]" /> Actionable
                    Recommendations
                  </h3>
                  <ul className="space-y-3">
                    {business.recommendations.map((rec, idx) => (
                      <li
                        key={idx}
                        className="flex items-start bg-[#FFFFFF] p-3 rounded-lg shadow-sm border border-[#2D6A4F]/20 border-l-4 border-l-[#2D6A4F]"
                      >
          ...
          {(activeTab === "aspects" ||
            ...
            <div className="space-y-8 print:break-before-page">
              <h2 className="text-2xl font-extrabold text-[#2B2B2B] mb-4 hidden print:block">
                Aspect-Based Sentiment
              </h2>
              <Card className="p-6">
                <h3 className="text-lg font-bold text-[#2B2B2B] mb-6 border-b border-[#6B705C]/20 pb-2">
                  Customer Sentiment by Aspect
                </h3>
                <div className="space-y-6">
                  {business.aspects.map((aspect) => (
                    <div key={aspect.name} className="flex flex-col">
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-bold text-[#2B2B2B]/90">
                          {aspect.name}
                        </span>
                        <span
                          className={`font-extrabold ${aspect.score >= 7 ? "text-[#2D6A4F]" : aspect.score >= 5 ? "text-[#6B705C]" : "text-[#C65D3B]"}`}
                        >
                      ...
                      <div className="h-4 w-full bg-[#FAF8F3] rounded-full flex overflow-hidden border border-[#6B705C]/10">
                        <div
                          ...
                          className="bg-[#2D6A4F] h-full relative group"
                        >
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-[#FFFFFF] font-bold bg-[#2B2B2B]/30">
                            {aspect.positive}%
                          </div>
                        </div>
                        <div
                          style={{
                            width: `${100 - aspect.positive - aspect.negative}%`,
                          }}
                          className="bg-[#6B705C]/80 h-full"
                        ></div>
                        <div
                          style={{ width: `${aspect.negative}%` }}
                          className="bg-[#C65D3B] h-full relative group"
                        >
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-[#FFFFFF] font-bold bg-[#2B2B2B]/30">
                            {aspect.negative}%
                          </div>
                ...
                <Card className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {business.keywords.positive.map((word) => (
                      <span
                        key={word}
                        className="px-3 py-1.5 bg-[#2D6A4F]/10 text-[#2D6A4F] border border-[#2D6A4F]/20 rounded-lg text-sm font-bold"
                      >
                        "{word}"
                      </span>
                    ))}
                ...
                <Card className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {business.keywords.negative.map((word) => (
                      <span
                        key={word}
                        className="px-3 py-1.5 bg-[#C65D3B]/10 text-[#C65D3B] border border-[#C65D3B]/20 rounded-lg text-sm font-bold"
                      >
                        "{word}"
                      </span>
                    ))}
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs font-semibold text-[#6B705C]/80">
                            {review.date}
                          </span>
                        </div>
                      ...
                      <p className="text-[#2B2B2B]/90 mb-4 text-sm leading-relaxed font-medium">
                        "{review.text}"
                      </p>
                      <div className="flex flex-wrap gap-2">
                        ...
                        {review.aspects.map((aspect) => (
                          <span
                            key={aspect}
                            className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 bg-[#6B705C]/10 text-[#6B705C] rounded"
                          >
                            {aspect}
                          </span>
                        ))}
